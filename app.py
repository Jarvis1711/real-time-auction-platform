...
STATUSES = ["scheduled", "active", "delayed", "completed"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="Real-Time Auction Platform",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="Logistics & Operations",
        ENTITY_SINGULAR="Real Time Operation",
        ENTITY_PLURAL="Real Time Operations",
    )
